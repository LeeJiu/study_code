...
{
	_background = IMAGEMANAGER->addImage( "bgLoading", "image/11111.bmp", WINSIZEX, WINSIZEY, false, false );

	_loadingBar = new progressBar;
	_loadingBar->init( "hpBarTop", "hpBarBottom", CENTERX - (WINSIZEX / 5 * 4) / 2, 450, WINSIZEX / 5 * 4, 10 );
